    ...
    <div class="table-responsive">
          <table id="tabel-data" class="table table-striped table-bordered" width="100%">
            ...
            <?php
                  ...
                  include "../koneksi.php ";
                  $data = mysqli_query($conn, "select * from katekumen");
                  $no = 1;
              ...
              <tr>
                ...
                <td>
                     <a href="index.php?p=edit_jadwal&id=<?=$result['id_katekumen'];?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>&nbsp;
                     <a onclick="return confirm('apakah anda yakin? ');" href="index.php?p=ac_delete_jadwal&id=<?=$result['id_katekumen'] ?>" class="btn btn-danger btn-sm"><i class= "fa fa-trash">&nbsp;</i></a>
                    </td>
              </tr>
              <?php
